...
const config: ExternalPluginConfig = {
  ...
  description: 'Stable terrain-aware wintry forecast using ECMWF vertical profiles and Windy local terrain. Shows adaptive snowline contours and a simple point card with weather type, temperature, RH, terrain versus snowline, precipitation, estimated new snow when relevant, snowline trend, a 144-hour graph, forecast soundings, search, favourites, and sharing.',
  author: 'Ramzi Kandah',
