...
const config: ExternalPluginConfig = {
  ...
  icon: '❄️',
  title: 'Snowline',
  description: 'ECMWF wet-bulb-zero snowline proxy to +144 h with adaptive contours, terrain-aware point labels, ±100 m classification and 3-hour tendency. Version 3 adds precipitation cues and bars, a draggable Snowline time graph, and an in-place partly-cloudy forecast button that automatically opens Windy weather detail at the selected point without changing map zoom. Includes search, favourites, My location, stable desktop/mobile selection, share/copy, help and caching.',
  author: 'Ramzi Kandah',
