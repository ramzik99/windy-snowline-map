<div class="chart-shell" role="dialog" aria-modal="false" aria-label="Snow forecast graph" bind:this={chartShell} style={`left:${position.x}px;top:${position.y}px;transform:none;`}>
  ...
  {#if chart}
    <div class="plot-wrap">
      <svg bind:this={svgEl} viewBox="0 0 360 334" role="img" aria-label="Terrain-aware snow forecast through 144 hours" on:pointermove={handlePointer} on:pointerdown={handlePointer} on:pointerleave={() => tooltip = null}>
